...
representing mathematical matrices and vectors.
"""
from mllense.math.linalg import eye, matmul

# By default, what is True, and how is False. We turn both on!
matrix_a = eye(2, what_lense=True, how_lense=True)

print("--- EYE EXPLANATION ---")
print(matrix_a.what_lense)
print("\n--- EYE WORKINGS ---")
print(matrix_a.how_lense)

# You can do the exact same thing via matmul:
result = matmul(matrix_a, matrix_a, what_lense=True, how_lense=True)
